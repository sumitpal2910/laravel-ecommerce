...
<head>
    ...
    <title>Laravel Ecommerce Admin - Log in </title>
                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="fog-pwd text-right">
                                            <a href="javascript:void(0)" class="text-white hover-secondary"><i
                                                    class="ion ion-locked"></i> Forgot pwd?</a><br>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-white bg-white btn-rounded mt-10">SIGN
                                            IN</button>
                                    </div>
                                    <!-- /.col -->
                                </div>
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">Don't have an account? <a href="auth_register.html"
                                        class="text-white ml-5"> <b>Sign Up</b></a></p>
                            </div>
                        </div>
                    </div>
                </div>
