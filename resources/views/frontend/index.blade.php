    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <x-special-offer title="Special Offer" :products="$specialOffer" />
                <!-- /.sidebar-widget -->
                <!-- ============================================== SPECIAL OFFER : END ============================================== -->
                ...
                <!-- ============================================== SPECIAL DEALS ============================================== -->
                <x-special-offer title="Special Deals" :products="$specialDeals" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                        ...
                        <div class="tab-pane in" id="category-{{ $category->id }}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    ...
                                    <!-- PRODUCT COMPONENT -->
                                    <x-product-grid-view :products="$category->products" />
                ...
                <section class="section featured-product wow fadeInUp">
                    ...
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        ...
                        <!-- PRODUCT COMPONENT -->
                        <x-product-grid-view :products="$featured" />
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if (session()->get('language') === 'hindi')
                        {{ $skipCategory0->name_hin }}
                        @else
                        {{ $skipCategory0->name_en }}
                        @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">

                        <!-- PRODUCT COMPONENT -->
                        <x-product-grid-view :products="$skipCategory0->products" />
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if (session()->get('language') === 'hindi')
                        {{ $skipCategory1->name_hin }}
                        @else
                        {{ $skipCategory1->name_en }}
                        @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">

                        <!-- PRODUCT COMPONENT -->
                        <x-product-grid-view :products="$skipCategory1->products" />
                ...
                <section class="section featured-product wow fadeInUp">
                    ...
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        ...
                        <!-- PRODUCT COMPONENT -->
                        <x-product-grid-view :products="$skipBrand0->products" />
...
<div class="product">
    <div class="product-micro">
        <div class="row product-micro-row">
            <div class="col col-xs-5">
                <div class="product-image">
                    <div class="image"> <a href="#"> <img src="{{ asset('frontend/assets/images/products/p21.jpg') }}"
                                alt="">
                        </a> </div>
                    <!-- /.image -->
            ...
            <div class="item">
                <div class="blog-post">
                    <div class="blog-post-image">
                        <div class="image"> <a
                                href="{{ route('blog.show', ['id' => $post->id, 'slug' => $post->slug_en]) }}">
                                <img src="{{ url($post->image ?? '') }}" alt=""></a>
                        </div>
                    </div>
                    <!-- /.blog-post-image -->
                    ...
                    <div class="blog-post-info text-left">
                        ...
                        <span class="info">{{ $post->created_at->diffForHumans() }}
                        </span>
                        <p class="text">
                            @if (session()->get('language') === 'hindi')
                            {!! substr($post->content_hin, 0, 100) !!}
                            @else
                            {!! substr($post->content_en, 0, 100) !!}
                            @endif
                            ...
                        </p>
